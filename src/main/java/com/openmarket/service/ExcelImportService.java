...
public class ExcelImportService {
    ...
    public ExcelImportResponse importReceiptItems(UUID shopId,
                                                  ...
                                                  UUID userId) {
        shopRepository.findByIdAndUserId(shopId, userId).orElseThrow(() -> new AppNotFoundException("Shop not found"));
        Receipt receipt = receiptRepository.findByIdAndShopId(receiptId, shopId).orElseThrow(() -> new AppNotFoundException("Receipt not found"));
        validateFile(file);
